...
class TestRandomForestRegressorModel(unittest.TestCase):
    def setUp(self):
        ...
        self.RFRM = RandomForestRegressorModel()

    def test_train_model(self):
        # Test if the model can be trained without errors
        self.RFRM.train_model()
    ...
    def test_evaluate_model(self):
        ...
        self.RFRM.evaluate_model(self.X_test, self.y_test)
    ...
    def test_predict_price(self):
        ...
        predicted_price = self.RFRM.predict_price(new_data)
