...
class TestDecisionTreeRegressorModel(unittest.TestCase):
    def setUp(self):
        ...
        self.DTRM = DecisionTreeRegressorModel()

    def test_train_model(self):
        # Test if the model can be trained without errors
        self.DTRM.train_model()
    ...
    def test_evaluate_model(self):
        ...
        self.DTRM.evaluate_model(self.X_test, self.y_test)
    ...
    def test_predict_price(self):
        ...
        predicted_price = self.DTRM.predict_price(new_data)
